...
int main(int argc, char* argv[])
{
  ...
  GLUI_Panel *light0 = new GLUI_Panel( glui_context, "Light 1" );
  GLUI_Panel *light1 = new GLUI_Panel( glui_context, "Light 2" );
  ...
  GLUI_EditText *counter_edittext = 
    new GLUI_EditText( glui_context, "Count:", &counter );
  counter_edittext->disable();

  /****** Button to Open Command Line Window ******/
  open_console_btn = 
    new GLUI_Button(glui_context, "Open Console", OPEN_CONSOLE_ID, pointer_cb);
