...
/*********************************************************************
  ...
  "NOT QUITE RIGHT YET" says definition
  ...
  update()         - Recalculates side and forward based on eye,
					 lookat, and up
  _dump()           - Prints class contents to a file
...
public:
	...
	/* function.                                               */
	void move(double side_move, double up_move, double forw_move);
	...
	/* stdin or stderr                                        */
	void _dump(FILE *output)const;
};

//---.
}//<-'

#endif //GLUI_VIEWMODEL_H
/*C1071*/
